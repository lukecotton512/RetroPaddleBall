...
@interface RPBBall : NSObject
{
    ...
    int ballHitCounterBottom;
    int ballHitCounterRandomBrick;
...
@property (nonatomic, assign) int ballHitCounterBottom;
@property (nonatomic, assign) int ballHitCounterRandomBrick;
